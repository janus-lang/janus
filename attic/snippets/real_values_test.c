...
int janus_main() {
    // DEBUG: Function has 21 children
    ...
    // Unsupported statement: integer_literal
    // DEBUG: Child node kind: let_stmt
    int var_c = 100; // let statement
    // DEBUG: Child node kind: identifier
    // Unsupported statement: identifier
    // DEBUG: Child node kind: integer_literal
    // Unsupported statement: integer_literal
    // DEBUG: Child node kind: let_stmt
    int var_d = 5; // let statement
    // DEBUG: Child node kind: identifier
    // Unsupported statement: identifier
    // DEBUG: Child node kind: integer_literal
    // Unsupported statement: integer_literal
    // DEBUG: Child node kind: let_stmt
    int var_e = 20; // let statement
    ...
    // Unsupported statement: identifier
    // Unsupported statement: integer_literal
    int var_f = 42; // let statement
    // Unsupported statement: identifier
    // Unsupported statement: integer_literal
    int var_g = 42; // let statement
    // Unsupported statement: identifier
    // Unsupported statement: integer_literal
    int var_h = 100; // let statement
    // Unsupported statement: identifier
    // Unsupported statement: integer_literal
    int var_i = 5; // let statement
    // Unsupported statement: identifier
    // Unsupported statement: integer_literal
    int var_j = 20; // let statement
    // Unsupported statement: string_literal
    janus_print("Parsed from real AST!");
    // Unsupported statement: string_literal
    janus_print("Parsed from real AST!");
