...
# Janus Deployment Checklist - 0.1.7 (20251029)

## ✅ Build Verification
- [ ] Core executables built and tested
- [ ] VSCode extension packaged (not built)
- [ ] All tests passing
- [ ] LSP functionality verified

## 📦 Package Updates
- [ ] AUR PKGBUILD updated to version 0.1.7
- [ ] Alpine APKBUILD updated to version 0.1.7
- [ ] Debian changelog updated to version 0.1.7
- [ ] Fedora spec updated to version 0.1.7
- [ ] VSCode extension updated to version 0.1.7
...
- [ ] Verify all profile functionality (:core, :service, :sovereign)
